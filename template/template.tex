...
\newcommand{\teamName}{DIU\_What_The_Bug}
\newcommand{\firstMember}{\color{specialist}NoObMin}
\newcommand{\secondMember}{\color{specialist}Nub27}
\newcommand{\thirdMember}{\color{pupil}nondonroy}
...
\newcommand{\maketeampage}{
	...
	\begin{center}
		...
		\vspace{2cm}
		{\fontsize{24}{30} \fontfamily{lmss} \selectfont {In Templates We Trust}}\\
		\vspace{1cm}
		\vspace{1cm}
	\end{center}
	\clearpage
